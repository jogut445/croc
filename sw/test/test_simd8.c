...
int main(void) {
    ...
    // pperm8: reverse byte order
    CHECK_ASSERT(14, simd_pperm8(PACK8(1, 2, 3, 4)) == PACK8(4, 3, 2, 1));
    CHECK_ASSERT(15, simd_pperm8(PACK8(0xDE, 0xAD, 0xBE, 0xEF)) == PACK8(0xEF, 0xBE, 0xAD, 0xDE));

    // popcount8
    CHECK_ASSERT(16, simd_popcount8(PACK8(0xFF, 0xAA, 0x0F, 0x00)) == PACK8(8, 4, 4, 0));
    CHECK_ASSERT(17, simd_popcount8(PACK8(0x01, 0x03, 0x07, 0x0F)) == PACK8(1, 2, 3, 4));

    // psll8
    CHECK_ASSERT(18, simd_psll8(PACK8(0x01, 0x02, 0x04, 0x08), 2u) == PACK8(0x04, 0x08, 0x10, 0x20));
    CHECK_ASSERT(19, simd_psll8(PACK8(0xAB, 0xCD, 0xEF, 0x12), 0u) == PACK8(0xAB, 0xCD, 0xEF, 0x12));

    // psrl8
    CHECK_ASSERT(20, simd_psrl8(PACK8(0x80, 0x40, 0x20, 0x10), 2u) == PACK8(0x20, 0x10, 0x08, 0x04));
    CHECK_ASSERT(21, simd_psrl8(PACK8(0xFF, 0xFF, 0xFF, 0xFF), 4u) == PACK8(0x0F, 0x0F, 0x0F, 0x0F));

    // prol8
    CHECK_ASSERT(22, simd_prol8(PACK8(0x80, 0xFF, 0x0F, 0xAA), 1u) == PACK8(0x01, 0xFF, 0x1E, 0x55));
    CHECK_ASSERT(23, simd_prol8(PACK8(0xDE, 0xAD, 0xBE, 0xEF), 0u) == PACK8(0xDE, 0xAD, 0xBE, 0xEF));
